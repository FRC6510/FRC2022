...
public class IntakeMasterTwoBalls extends ParallelCommandGroup {
  /** Creates a new Intake. */
  public IntakeMasterTwoBalls(Intake intake,Feeder feeder) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    //addCommands(new ScheduleCommand(intake, feeder), new IndexFirstBall(feeder));
    addCommands(
      new IntakeTwoBalls(intake), new IndexFirstBall(feeder));
